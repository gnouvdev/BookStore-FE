...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React15 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is3, useSyncExternalStore2 = React15.useSyncExternalStore, useRef8 = React15.useRef, useEffect11 = React15.useEffect, useMemo8 = React15.useMemo, useDebugValue3 = React15.useDebugValue;
...
var PencilLine = createLucideIcon("pencil-line", __iconNode3);
...
var Save = createLucideIcon("save", __iconNode4);
...
var uploadToCloudinary = async (file) => {
  ...
  try {
    ...
    zt.error("Failed to upload image");
    return null;
  }
};

// src/redux/features/users/userApi.js
var userApi = createApi2({
  reducerPath: "userApi",
  baseQuery: fetchBaseQuery({
    baseUrl: baseURL_default,
    credentials: "include",
...
var Profile = () => {
  ...
  const { data: profileResponse, isLoading: isLoadingProfile } = useGetUserProfileQuery(void 0, {
    skip: !token
  });
  const { data: ordersResponse } = useGetOrdersQuery(currentUser?.email, {
    skip: !currentUser?.email
  });
  const [updateProfile2, { isLoading: isSaving }] = useUpdateProfileMutation();
  const [isEditing, setIsEditing] = (0, import_react20.useState)(false);
  const [selectedFile, setSelectedFile] = (0, import_react20.useState)(null);
  ...
  const handleChange = (event) => {
    const { name: name4, value } = event.target;
    if (name4.startsWith("address.")) {
      const field = name4.split(".")[1];
      setFormData((prev) => ({
        ...prev,
    ...
    setFormData((prev) => ({ ...prev, [name4]: value }));
  };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        if (!nextPhotoURL) {
          throw new Error(t2("bookeco.profile.upload_error", { defaultValue: "Kh\xF4ng th\u1EC3 t\u1EA3i \u1EA3nh \u0111\u1EA1i di\u1EC7n l\xEAn l\xFAc n\xE0y." }));
        }
      }
      const response = await updateProfile2({ ...formData, photoURL: nextPhotoURL }).unwrap();
      ...
      setIsEditing(false);
      n2.success(t2("bookeco.profile.saved", { defaultValue: "\u0110\xE3 c\u1EADp nh\u1EADt h\u1ED3 s\u01A1 ng\u01B0\u1EDDi d\xF9ng." }));
    } catch (submitError) {
      n2.error(submitError?.data?.message || t2("bookeco.profile.save_error", { defaultValue: "Kh\xF4ng th\u1EC3 c\u1EADp nh\u1EADt h\u1ED3 s\u01A1 l\xFAc n\xE0y." }));
    }
  };
  ...
  if ((loading || isLoadingProfile) && !profile.email) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("section", { className: "bookeco-desk-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-container", children: t2("bookeco.profile.loading", { defaultValue: "\u0110ang t\u1EA3i h\u1ED3 s\u01A1..." }) }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("section", { className: "bookeco-desk-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("header", { className: "bookeco-desk-header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: "BookEco" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h1", { children: t2("bookeco.profile.title", { defaultValue: "Kh\xF4ng gian \u0111\u1ED9c gi\u1EA3" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-layout", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("aside", { className: "bookeco-desk-sidebar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("nav", { className: "bookeco-desk-nav", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/profile", className: "is-active", children: [
            t2("common.profile", { defaultValue: "H\u1ED3 s\u01A1" }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 14 })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/orders", children: [
            t2("common.orders", { defaultValue: "\u0110\u01A1n h\xE0ng" }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 14 })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/notifications", children: [
            t2("common.notifications", { defaultValue: "Th\xF4ng b\xE1o" }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 14 })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/wishlist", children: [
            t2("common.wishlist", { defaultValue: "Y\xEAu th\xEDch" }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 14 })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-quote", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.profile.quote", { defaultValue: "M\u1ED9t t\u1EE7 s\xE1ch \u0111\u1EB9p kh\xF4ng ch\u1EC9 n\u1EB1m \u1EDF s\u1ED1 l\u01B0\u1EE3ng, m\xE0 \u1EDF c\xE1ch n\xF3 ph\u1EA3n chi\u1EBFu gu \u0111\u1ECDc c\u1EE7a ng\u01B0\u1EDDi s\u1EDF h\u1EEFu." }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "BookEco Notes" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-main", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-desk-profile-hero", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-portrait-frame", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: formData.photoURL || "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y", alt: formData.fullName || "User" }),
            isEditing ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "bookeco-desk-avatar-trigger", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Camera, { size: 14 }),
              " ",
              t2("bookeco.profile.choose_image", { defaultValue: "\u0110\u1ED5i \u1EA3nh \u0111\u1EA1i di\u1EC7n" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { type: "file", accept: "image/*", hidden: true, onChange: handleFileChange })
            ] }) : null
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-profile-copy", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-profile-line", children: t2("bookeco.profile.badge", { defaultValue: "Reader Profile" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-profile-name", children: formData.fullName || t2("bookeco.profile.fallback_name", { defaultValue: "\u0110\u1ED9c gi\u1EA3 BookEco" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-profile-role", children: formData.phone ? `${t2("cart.phone_number", { defaultValue: "S\u1ED1 \u0111i\u1EC7n tho\u1EA1i" })}: ${formData.phone}` : t2("bookeco.profile.role", { defaultValue: "\u0110\u1ED9c gi\u1EA3 \u0111ang x\xE2y d\u1EF1ng t\u1EE7 s\xE1ch c\xE1 nh\xE2n" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-profile-sub", children: t2("bookeco.profile.subline", { defaultValue: "Th\xF4ng tin t\xE0i kho\u1EA3n \u0111\u01B0\u1EE3c \u0111\u1ED3ng b\u1ED9 cho c\xE1c \u0111\u01A1n h\xE0ng ti\u1EBFp theo" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-avatar-note", children: isEditing ? t2("bookeco.profile.avatar_editing", { defaultValue: "Khung ch\xE2n dung \u0111ang m\u1EDF \u0111\u1EC3 b\u1EA1n ch\u1ECDn \u1EA3nh \u0111\u1EA1i di\u1EC7n m\u1EDBi." }) : t2("bookeco.profile.avatar_note", { defaultValue: "B\u1EADt ch\u1EC9nh s\u1EEDa h\u1ED3 s\u01A1 \u0111\u1EC3 c\u1EADp nh\u1EADt \u1EA3nh \u0111\u1EA1i di\u1EC7n v\xE0 th\xF4ng tin c\xE1 nh\xE2n." }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-badges", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.profile.member_rank", { defaultValue: "H\u1EA1ng th\xE0nh vi\xEAn" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: t2("bookeco.profile.member_value", { defaultValue: "Reader's Circle" }) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.profile.account_status", { defaultValue: "Tr\u1EA1ng th\xE1i t\xE0i kho\u1EA3n" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: t2("bookeco.profile.account_value", { defaultValue: "\u0110\xE3 x\xE1c th\u1EF1c" }) })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-section-head", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "bookeco-desk-section-title", children: t2("bookeco.profile.stats_title", { defaultValue: "T\u1ED5ng quan h\u1ED3 s\u01A1" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "bookeco-desk-inline-button", onClick: () => setIsEditing((prev) => !prev), children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PencilLine, { size: 14 }),
              " ",
              isEditing ? t2("bookeco.profile.close_edit", { defaultValue: "\u0110\xF3ng ch\u1EC9nh s\u1EEDa" }) : t2("bookeco.profile.edit", { defaultValue: "Ch\u1EC9nh s\u1EEDa h\u1ED3 s\u01A1" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-stats", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "bookeco-desk-stat-card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("common.orders", { defaultValue: "\u0110\u01A1n h\xE0ng" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: orders.length }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.profile.stats_orders", { defaultValue: "S\u1ED1 \u0111\u01A1n b\u1EA1n \u0111\xE3 t\u1EA1o v\xE0 theo d\xF5i trong h\u1EC7 th\u1ED1ng BookEco." }) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "bookeco-desk-stat-card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.profile.address_status", { defaultValue: "\u0110\u1ECBa ch\u1EC9 giao h\xE0ng" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: formData.address.street ? t2("bookeco.profile.ready", { defaultValue: "S\u1EB5n s\xE0ng" }) : t2("bookeco.profile.missing", { defaultValue: "Thi\u1EBFu" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.profile.stats_address", { defaultValue: "Ho\xE0n thi\u1EC7n \u0111\u1ECBa ch\u1EC9 gi\xFAp l\u1EA7n thanh to\xE1n ti\u1EBFp theo di\u1EC5n ra nhanh h\u01A1n." }) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "bookeco-desk-stat-card is-dark", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.profile.profile_state", { defaultValue: "Tr\u1EA1ng th\xE1i h\u1ED3 s\u01A1" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: profile.email ? t2("bookeco.profile.active", { defaultValue: "Active" }) : t2("bookeco.profile.draft", { defaultValue: "Draft" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: profile.email ? t2("bookeco.profile.stats_active", { defaultValue: "Th\xF4ng tin \u0111\xE3 \u0111\u1EE7 \u0111\u1EC3 s\u1EB5n s\xE0ng cho c\xE1c \u0111\u01A1n h\xE0ng ti\u1EBFp theo." }) : t2("bookeco.profile.stats_draft", { defaultValue: "H\u1ED3 s\u01A1 \u0111ang ch\u1EDD \u0111\u01B0\u1EE3c b\u1ED5 sung th\xEAm th\xF4ng tin." }) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-section-head", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "bookeco-desk-section-title", children: t2("bookeco.profile.info_title", { defaultValue: "Th\xF4ng tin c\xE1 nh\xE2n" }) }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("form", { className: "bookeco-account-form", onSubmit: handleSubmit, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-form-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-field-grid", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "is-wide", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.full_name", { defaultValue: "H\u1ECD v\xE0 t\xEAn" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "fullName", value: formData.fullName, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.email_address", { defaultValue: "Email" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "email", value: formData.email, disabled: true })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.phone_number", { defaultValue: "S\u1ED1 \u0111i\u1EC7n tho\u1EA1i" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "phone", value: formData.phone, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { className: "is-wide", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.address", { defaultValue: "\u0110\u1ECBa ch\u1EC9" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "address.street", value: formData.address.street, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.city", { defaultValue: "Th\xE0nh ph\u1ED1" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "address.city", value: formData.address.city, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.country", { defaultValue: "Qu\u1ED1c gia" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "address.country", value: formData.address.country, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("cart.zipcode", { defaultValue: "M\xE3 b\u01B0u ch\xEDnh" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { name: "address.zip", value: formData.address.zip, onChange: handleChange, disabled: !isEditing })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.profile.avatar", { defaultValue: "\u1EA2nh \u0111\u1EA1i di\u1EC7n" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { value: selectedFile?.name || t2("bookeco.profile.avatar_hint", { defaultValue: "Ch\u1ECDn \u1EA3nh \u1EDF khung ch\xE2n dung b\xEAn tr\xEAn khi b\u1EADt ch\u1EC9nh s\u1EEDa." }), disabled: true, readOnly: true })
              ] })
            ] }) }),
            isEditing ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-account-actions", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "submit", className: "bookeco-button-primary", disabled: isSaving, children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Save, { size: 14 }),
              " ",
              isSaving ? t2("bookeco.profile.saving", { defaultValue: "\u0110ang l\u01B0u..." }) : t2("bookeco.profile.save", { defaultValue: "L\u01B0u thay \u0111\u1ED5i" })
            ] }) }) : null
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-section-head", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "bookeco-desk-section-title", children: t2("bookeco.profile.recent_orders", { defaultValue: "\u0110\u01A1n h\xE0ng g\u1EA7n \u0111\xE2y" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { to: "/orders", className: "bookeco-desk-link-inline", children: t2("common.view_all", { defaultValue: "Xem to\xE0n b\u1ED9" }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-list", children: recentAcquisitions.length ? recentAcquisitions.map((order) => {
            const item = order.productIds?.[0];
            const product = item?.productId;
            return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: `/orders/${order._id}`, className: "bookeco-desk-list-item bookeco-link-reset", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: product?.coverImage || "https://via.placeholder.com/76x106?text=Book", alt: product?.title || "Book" }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-list-copy", children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("small", { children: new Date(order.createdAt).toLocaleDateString("vi-VN") }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: product?.title || `#${order._id.slice(-6)}` }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: product?.author?.name || t2("bookeco.profile.order_fallback", { defaultValue: "\u0110\u01A1n h\xE0ng trong t\u1EE7 s\xE1ch c\u1EE7a b\u1EA1n" }) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-list-price", children: [
          ...
          }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-quote", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.profile.no_orders", { defaultValue: "B\u1EA1n ch\u01B0a c\xF3 \u0111\u01A1n h\xE0ng n\xE0o \u0111\u1EC3 hi\u1EC3n th\u1ECB \u1EDF \u0111\xE2y." }) }) }) })
        ] })
      ] })
    ] })
  ] }) });
