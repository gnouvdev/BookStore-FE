...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React15 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is3, useSyncExternalStore2 = React15.useSyncExternalStore, useRef8 = React15.useRef, useEffect11 = React15.useEffect, useMemo9 = React15.useMemo, useDebugValue3 = React15.useDebugValue;
...
var MoveRight = createLucideIcon("move-right", __iconNode2);
...
var ShoppingBag = createLucideIcon("shopping-bag", __iconNode3);
...
var categoriesApi = createApi2({
  ...
  endpoints: (builder) => ({
    ...
    searchCategories: builder.query({
      query: (name4) => `/categories/search?name=${name4}`,
      providesTags: ["Categories"]
    }),
...
var AuthContext = (0, import_react19.createContext)(null);
...
var banner_1_default = "./banner-1-O4VFSRK3.png";

// src/assets/banner/banner-2.png
var banner_2_default = "./banner-2-XQ47XF5B.png";

// src/assets/banner/banner-3.png
var banner_3_default = "./banner-3-J3WBEWCO.png";

// src/assets/banner/banner-4.png
var banner_4_default = "./banner-4-JK5RDFLE.png";

// src/assets/banner/banner-5.png
var banner_5_default = "./banner-5-TAD4EGVK.png";

// src/pages/home/Home.jsx
var import_react21 = __toESM(require_react(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var CATEGORY_ROUTE_MAP = {
...
var HERO_QUOTES = [
  { key: "quote_1", image: banner_1_default },
  { key: "quote_2", image: banner_2_default },
  { key: "quote_3", image: banner_3_default },
  { key: "quote_4", image: banner_4_default },
  { key: "quote_5", image: banner_5_default }
];
var normalizeText = (value = "") => value.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
...
var TAG_LABEL_MAP = {
  bacho: "B\xE1c H\u1ED3",
  thieunhi: "thi\u1EBFu nhi",
  thieunien: "thi\u1EBFu ni\xEAn",
  giaoduc: "gi\xE1o d\u1EE5c",
  lichsu: "l\u1ECBch s\u1EED",
  truyentranh: "truy\u1EC7n tranh"
};
var formatSpotlightTag = (tag = "") => {
  const normalized = normalizeText(tag).replace(/\s+/g, "");
  return TAG_LABEL_MAP[normalized] || tag;
};
var getSpotlightNarrative = (book, t2) => {
  if (!book) {
    return {
      intro: t2("bookeco.home.spotlight_intro_fallback", {
        defaultValue: "M\u1ED9t l\u1EF1a ch\u1ECDn \u0111ang \u0111\u01B0\u1EE3c gi\u1EEF ch\u1ED7 trong b\u1ED9 s\u01B0u t\u1EADp n\u1ED5i b\u1EADt h\xF4m nay."
      }),
      details: []
    };
  }
  const categoryName = book.category?.name || t2("common.books", { defaultValue: "s\xE1ch" });
  const authorName = book.author?.name || t2("books.author", { defaultValue: "t\xE1c gi\u1EA3 \u0111ang c\u1EADp nh\u1EADt" });
  const tags = Array.isArray(book.tags) ? book.tags.map(formatSpotlightTag).filter(Boolean).slice(0, 2) : [];
  const isRespectfulContext = /hồ chí minh|ho chi minh/i.test(authorName) || tags.includes("B\xE1c H\u1ED3");
  const intro = t2("bookeco.home.spotlight_intro", {
    defaultValue: `${book.title} l\xE0 l\u1EF1a ch\u1ECDn n\u1ED5i b\u1EADt cho nh\u1EEFng ai \u0111ang t\xECm m\u1ED9t cu\u1ED1n ${categoryName.toLowerCase()} c\xF3 nh\u1ECBp k\u1EC3 cu\u1ED1n h\xFAt v\xE0 c\xE1 t\xEDnh r\xF5 r\xE0ng trong t\u1EE7 s\xE1ch hi\u1EC7n t\u1EA1i.`
  });
  const details = [
    isRespectfulContext ? t2("bookeco.home.spotlight_detail_author_respectful", {
      defaultValue: `Cu\u1ED1n s\xE1ch \u0111\u01B0\u1EE3c gi\u1EDBi thi\u1EC7u \u1EDF \u0111\xE2y nh\u01B0 m\u1ED9t l\u1EF1a ch\u1ECDn trang tr\u1ECDng, ph\xF9 h\u1EE3p cho b\u1EA1n \u0111\u1ECDc mu\u1ED1n t\xECm l\u1EA1i nh\u1EEFng gi\xE1 tr\u1ECB l\u1ECBch s\u1EED, k\xFD \u1EE9c v\xE0 c\u1EA3m h\u1EE9ng s\u1ED1ng \u0111\u1EB9p.`
    }) : t2("bookeco.home.spotlight_detail_author", {
      defaultValue: `T\xEAn tu\u1ED5i ${authorName} gi\xFAp cu\u1ED1n s\xE1ch gi\u1EEF \u0111\u01B0\u1EE3c c\u1EA3m gi\xE1c c\xF3 tr\u1ECDng l\u01B0\u1EE3ng, \u0111\u1EE7 \u0111\u1EC3 tr\u1EDF th\xE0nh \u0111i\u1EC3m nh\u1EA5n ngay t\u1EEB l\u1EA7n ch\u1EA1m \u0111\u1EA7u ti\xEAn.`
    }),
    tags.length ? t2("bookeco.home.spotlight_detail_tags", {
      defaultValue: isRespectfulContext ? `M\u1EA1ch n\u1ED9i dung xoay quanh ${tags.join(" v\xE0 ")} khi\u1EBFn cu\u1ED1n s\xE1ch n\xE0y ph\xF9 h\u1EE3p \u0111\u1EC3 gi\u1EDBi thi\u1EC7u trong d\u1ECBp \u0111\u1EB7c bi\u1EC7t, nh\u01B0ng v\u1EABn gi\u1EEF \u0111\u01B0\u1EE3c s\u1EF1 ch\u1EC9n chu v\xE0 t\xF4n tr\u1ECDng c\u1EA7n c\xF3.` : `Kh\xF4ng kh\xED g\u1EE3i m\u1EDF t\u1EEB ${tags.join(" v\xE0 ")} khi\u1EBFn cu\u1ED1n n\xE0y h\u1EE3p \u0111\u1EC3 \u0111\u1EB7t \u1EDF v\u1ECB tr\xED trung t\xE2m c\u1EE7a m\u1ED9t b\u1ED9 s\u01B0u t\u1EADp \u0111ang c\u1EA7n th\xEAm d\u1EA5u \u1EA5n.`
    }) : t2("bookeco.home.spotlight_detail_category", {
      defaultValue: `N\u1EBFu b\u1EA1n \u0111ang t\xECm m\u1ED9t \u0111\u1EA7u s\xE1ch c\xF3 b\u1EA3n s\u1EAFc r\xF5 trong nh\xF3m ${categoryName.toLowerCase()}, \u0111\xE2y l\xE0 l\u1EF1a ch\u1ECDn \u0111\xE1ng \u0111\u1EC3 m\u1EDF xem ngay.`
    })
  ];
  return { intro, details };
};
var getCategoryRoute = (categoryName) => CATEGORY_ROUTE_MAP[normalizeText(categoryName)] || "/product";
var pickHeroBook = (books) => [...books].sort((a2, b3) => new Date(b3.createdAt || 0) - new Date(a2.createdAt || 0))[0] || null;
var getReviewScore = (book) => Number(book?.rating || book?.averageRating || 0) * 100 + Number(book?.numReviews || book?.reviewCount || 0);
var BookTile = ({ book, compact = false, className = "", t: t2 }) => {
  if (!book) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: `/books/${book._id}`, className: `bookeco-book-tile ${compact ? "bookeco-book-tile-compact" : ""} ${className}`.trim(), children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-book-image-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: book.coverImage, alt: book.title, className: "bookeco-book-image", loading: "lazy" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-book-copy", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: book.title }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: book.author?.name || t2("books.author", { defaultValue: "T\xE1c gi\u1EA3" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatPrice(getBookPrice(book)) })
    ] })
  ] });
};
var ContextualSwapTile = ({ book, active = false, onSelect, t: t2 }) => {
  if (!book) return null;
...
var SpotlightRecommendation = ({ book, t: t2 }) => {
  if (!book) return null;
  const narrative = getSpotlightNarrative(book, t2);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: `/books/${book._id}`, className: "bookeco-spotlight-card", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-spotlight-media", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: book.coverImage, alt: book.title, className: "bookeco-spotlight-image", loading: "lazy" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-spotlight-overlay" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-spotlight-copy", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-spotlight-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: book.title }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: book.author?.name || t2("books.author", { defaultValue: "T\xE1c gi\u1EA3" }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-spotlight-body", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "bookeco-spotlight-intro", children: narrative.intro }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-spotlight-details", children: narrative.details.map((detail) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: detail }, detail)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-spotlight-footer", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatPrice(getBookPrice(book)) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "bookeco-spotlight-link", children: [
          t2("bookeco.home.discover_now", { defaultValue: "Kh\xE1m ph\xE1 ngay" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 16 })
        ] })
      ] })
    ] })
  ] });
};
var CategoryCard = ({ category, featured = false, t: t2 }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    Link,
    {
      ...
      style: category.coverImage ? { backgroundImage: `linear-gradient(180deg, rgba(66, 4, 9, 0.1), rgba(66, 4, 9, 0.72)), url(${category.coverImage})` } : void 0,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-category-card-copy", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: category.name }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: category.countLabel })
        ] }),
        featured ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "bookeco-category-cta", children: [
          t2("common.view_all", { defaultValue: "Xem danh m\u1EE5c" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MoveRight, { size: 16 })
        ] }) : null
      ]
    }
  );
...
var Home = () => {
  ...
  const { data: collaborativeData } = useGetCollaborativeRecommendationsQuery(void 0, { skip: !currentUser });
  const { data: contextualData } = useGetContextualRecommendationsQuery(void 0, { skip: !currentUser });
  const [visiblePersonalizedCount, setVisiblePersonalizedCount] = (0, import_react20.useState)(4);
  const [selectedContextualLeadId, setSelectedContextualLeadId] = (0, import_react20.useState)("");
  const featuredBook = (0, import_react20.useMemo)(() => pickHeroBook(books), [books]);
  const mood = (0, import_react20.useMemo)(() => {
  ...
  const popularBooks = (0, import_react20.useMemo)(() => [...books].sort((a2, b3) => {
    const diff = getReviewScore(b3) - getReviewScore(a2);
    return diff !== 0 ? diff : new Date(b3.createdAt || 0) - new Date(a2.createdAt || 0);
  }).slice(0, 5), [books]);
  ...
  const latestBooks = (0, import_react20.useMemo)(() => [...books].sort((a2, b3) => new Date(b3.createdAt || 0) - new Date(a2.createdAt || 0)).slice(0, 6), [books]);
  const personalizedBooks = (0, import_react20.useMemo)(() => {
  ...
  const contextualBooks = (0, import_react20.useMemo)(() => {
    const source = Array.isArray(contextualData?.data) ? contextualData.data : [];
    return source.slice(0, 4);
  }, [contextualData]);
  const contextualLeadBook = (0, import_react20.useMemo)(() => {
  ...
  const contextualSideBooks = (0, import_react20.useMemo)(
  ...
  const contextualLabel = (0, import_react20.useMemo)(() => {
    const context = contextualData?.context;
    if (!context) return "";
    if (context.holidayName) {
      if (context.isHoliday) {
        return t2("bookeco.home.contextual_today_holiday", {
          defaultValue: `H\xF4m nay d\xE0nh cho ${context.holidayName}`
        });
      }
      if (typeof context.daysUntil === "number" && context.daysUntil > 0) {
        return t2("bookeco.home.contextual_upcoming_holiday", {
  ...
  const contextualKicker = (0, import_react20.useMemo)(() => {
    const context = contextualData?.context;
    if (!context) return "";
    if (context.isHoliday) {
      return t2("bookeco.home.contextual_kicker_today", { defaultValue: "D\xE0nh cho d\u1ECBp h\xF4m nay" });
    }
    return t2("bookeco.home.contextual_kicker_upcoming", { defaultValue: "\u0110\xF3n d\u1ECBp s\u1EAFp t\u1EDBi" });
  }, [contextualData, t2]);
  const categoryCards = (0, import_react20.useMemo)(() => {
    ...
    return categories.slice(0, 4).map((category, index) => {
      ...
      return {
        ...
        name: category.name,
        countLabel: `${relatedBooks.length || 0} ${t2("bookeco.home.book_titles", { defaultValue: "\u0111\u1EA7u s\xE1ch" })}`,
  ...
  if (isLoading && books.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-home-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-loading-state", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-loading-card" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-loading-card" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-loading-card" })
    ] }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-home-shell", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-hero", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-hero-backdrop", style: { backgroundImage: `linear-gradient(90deg, rgba(254, 249, 240, 0.92), rgba(254, 249, 240, 0.24)), url(${mood.image})` } }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-hero-copy", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: t2("common.new_arrivals", { defaultValue: "M\u1EDBi c\u1EADp nh\u1EADt" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h1", { className: "bookeco-hero-title", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.home.hero_line_one", { defaultValue: "N\u01A1i d\xE0nh cho" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-hero-title-italic", children: t2("bookeco.home.hero_line_two", { defaultValue: "nh\u1EEFng cu\u1ED1n s\xE1ch \u0111\xE1ng gi\u1EEF l\u1EA1i" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "bookeco-hero-description", children: [
          "\u201C",
          t2(`bookeco.home.${mood.key}`, { defaultValue: "M\u1ED9t cu\u1ED1n s\xE1ch hay kh\xF4ng c\u1EA7n \u1ED3n \xE0o, ch\u1EC9 c\u1EA7n \u0111\u1EBFn \u0111\xFAng l\xFAc v\xE0 \u1EDF l\u1EA1i \u0111\u1EE7 l\xE2u." }),
          "\u201D"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "bookeco-hero-attribution", children: "BookEco Selection" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-hero-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { to: featuredBook ? `/books/${featuredBook._id}` : "/product?sort=newest", className: "bookeco-primary-button", children: t2("bookeco.home.cta_newest", { defaultValue: "Xem s\xE1ch m\u1EDBi nh\u1EA5t" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { to: "/product", className: "bookeco-secondary-link", children: t2("common.view_all", { defaultValue: "Xem to\xE0n b\u1ED9 s\u1EA3n ph\u1EA9m" }) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-hero-visual", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-hero-card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-hero-book-frame", children: featuredBook?.coverImage ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: featuredBook.coverImage, alt: featuredBook.title, className: "bookeco-hero-book-image" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-hero-book-placeholder" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-hero-badge", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t2("bookeco.home.newest_badge", { defaultValue: "T\u1EF1a s\xE1ch v\u1EEBa c\u1EADp nh\u1EADt" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: featuredBook?.title || t2("bookeco.home.updating", { defaultValue: "\u0110ang c\u1EADp nh\u1EADt kho s\xE1ch" }) })
        ] })
      ] }) })
    ] }),
    currentUser && contextualBooks.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-personalized-section bookeco-personalized-section-contextual", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-section-header", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-section-header-copy", children: [
        contextualKicker ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: contextualKicker }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: contextualLabel })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-contextual-spotlight", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SpotlightRecommendation, { book: contextualLeadBook, t: t2 }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-contextual-side-stack", children: contextualSideBooks.map((book, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ContextualSwapTile,
          {
            book,
    ...
    currentUser && personalizedBooks.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-personalized-section bookeco-personalized-section-personal", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-section-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-section-header-copy", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: t2("bookeco.home.for_you", { defaultValue: "D\xE0nh cho b\u1EA1n" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: t2("bookeco.home.personalized_title", { defaultValue: "Nh\u1EEFng l\u1EF1a ch\u1ECDn h\u1EE3p v\u1EDBi gu \u0111\u1ECDc c\u1EE7a b\u1EA1n" }) })
        ] }),
        Array.isArray(collaborativeData?.data) && collaborativeData.data.length > visiblePersonalizedCount ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "bookeco-inline-text-button", onClick: () => setVisiblePersonalizedCount((count) => count + 4), children: [
          t2("bookeco.home.show_more_suggestions", { defaultValue: "Xem th\xEAm g\u1EE3i \xFD" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 16 })
        ] }) : null
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-personalized-track", children: personalizedBooks.map((book, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        BookTile,
        {
          book,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-curated-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-section-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: t2("common.collections", { defaultValue: "Tuy\u1EC3n ch\u1ECDn" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: t2("bookeco.home.curated_title", { defaultValue: "Nh\u1EEFng t\u1EF1a s\xE1ch \u0111\u01B0\u1EE3c y\xEAu th\xEDch nh\u1EA5t" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/product?sort=rating", className: "bookeco-header-link", children: [
          t2("common.view_all", { defaultValue: "Xem to\xE0n b\u1ED9 s\u1EA3n ph\u1EA9m" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronRight, { size: 16 })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-curated-grid", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "bookeco-feature-card ", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-feature-image", children: curatedFeaturedBook?.coverImage ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: curatedFeaturedBook.coverImage, alt: curatedFeaturedBook.title }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-image-placeholder" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-feature-copy", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: curatedFeaturedBook?.title || t2("bookeco.home.updating", { defaultValue: "\u0110ang c\u1EADp nh\u1EADt" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: curatedFeaturedBook?.author?.name || t2("books.author", { defaultValue: "T\xE1c gi\u1EA3" }) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-feature-footer", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatPrice(getBookPrice(curatedFeaturedBook)) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { to: curatedFeaturedBook ? `/books/${curatedFeaturedBook._id}` : "/product?sort=rating", className: "bookeco-icon-button", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ShoppingBag, { size: 16 }) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-curated-side-grid", children: curatedSideBooks.map((book) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BookTile, { book, compact: true, t: t2 }, book._id)) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-archived-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-archived-heading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: t2("common.new_arrivals", { defaultValue: "M\u1EDBi c\u1EADp nh\u1EADt" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: t2("bookeco.home.latest_title", { defaultValue: "S\xE1ch v\u1EEBa c\xF3 m\u1EB7t tr\xEAn k\u1EC7" }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-archived-row", children: latestBooks.map((book) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: `/books/${book._id}`, className: "bookeco-archived-card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-archived-image", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { src: book.coverImage, alt: book.title, loading: "lazy" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-archived-copy", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: book.title }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: book.author?.name || t2("books.author", { defaultValue: "T\xE1c gi\u1EA3" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: formatPrice(getBookPrice(book)) })
        ] })
    ...
    categoryCards.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "bookeco-categories-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-section-header", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "bookeco-kicker", children: t2("bookeco.home.categories_label", { defaultValue: "Duy\u1EC7t theo danh m\u1EE5c" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { children: t2("bookeco.home.categories_title", { defaultValue: "T\xECm s\xE1ch theo m\u1ED1i quan t\xE2m c\u1EE7a b\u1EA1n" }) })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-categories-grid", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-category-column bookeco-category-column-left", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CategoryCard, { category: categoryCards[0], t: t2 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-category-column bookeco-category-column-middle", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CategoryCard, { category: categoryCards[1], t: t2 }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CategoryCard, { category: categoryCards[2], t: t2 })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-category-column bookeco-category-column-right", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CategoryCard, { category: categoryCards[3], featured: true, t: t2 }) })
      ] })
    ] }) : null
  ] });
};
