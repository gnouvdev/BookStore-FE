            ...
            <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl">
                <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                    <div className="flex items-start justify-between">
                        <div className="text-4xl font-semibold text-gray-900">Shopping Cart</div>
                                                    ...
                                                    <div className="ml-4 flex flex-1 flex-col">
                                                        <div>
                                                            <div className="flex flex-wrap justify-between text-base font-medium text-gray-900">
                                                                ...
                                                                <p className="sm:ml-4">
                                                                    ${product?.newPrice && product.quantity ? (product.newPrice * product.quantity).toFixed(2) : "0.00"}
                                                                </p>
                                                            </div>
                                                        ...
                                                        <div className="flex flex-1 flex-wrap items-end justify-between space-y-2 text-sm">
                                                            <div className="flex items-center">
                                                                ...
                                                                <p className="mx-2 text-gray-900">{product.quantity || 1}</p>
