...
const EnhancedRecommendationsv2 = () => {
  ...
  if (isLoading) {
    return (
      ...
      >
        {/* Animated Background */}
        <div className="absolute inset-0 bg-[#FBEAEB]">
          <motion.div
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.h2
              className="text-4xl md:text-5xl font-bold text-[#2F3C7E] mb-4"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[#FBEAEB]">
        <motion.div
          className="absolute top-0 left-0 w-96 h-96 bg-amber-200/20 rounded-full blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, 50, 0],
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-rose-200/20 rounded-full blur-3xl"
          animate={{
            x: [0, -80, 0],
            y: [0, -60, 0],
            scale: [1.2, 1, 1.2],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.h2
            ref={titleRef}
            className="text-4xl md:text-6xl font-extrabold mb-4 text-[#2F3C7E]"
            style={{
        ...
        >
          <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            ...
            <motion.div
              className="absolute top-4 left-4 w-8 h-8 bg-[#2F3C7E] opacity-80 rounded-full"
              animate={{ rotate: 360, scale: [1, 1.2, 1] }}
              transition={{ duration: 4, repeat: Number.POSITIVE_INFINITY }}
            />
            <motion.div
              className="absolute top-4 right-4 w-6 h-6 bg-[#2F3C7E] opacity-80 rounded-full"
              animate={{ rotate: -360, scale: [1.2, 1, 1.2] }}
              transition={{ duration: 5, repeat: Number.POSITIVE_INFINITY }}
            />
            <motion.div
              className="absolute bottom-4 left-4 w-10 h-10 bg-[#2F3C7E] opacity-80 rounded-full"
              animate={{ rotate: 180, scale: [1, 1.3, 1] }}
              transition={{ duration: 6, repeat: Number.POSITIVE_INFINITY }}
            />
            <motion.div
              className="absolute bottom-4 right-4 w-7 h-7 bg-[#2F3C7E] opacity-80 rounded-full"
                  ...
                  {data.data.map((book, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <motion.div
                          className="absolute -top-3 -right-3 z-20 bg-[#2F3C7E] text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg"
                          initial={{ scale: 0, rotate: -180 }}
                          animate={{ scale: 1, rotate: 0 }}
                          transition={{
                            delay: index * 0.1 + 0.5,
                        ...
                        {index < 3 && (
                          <motion.div
                            className="absolute -top-3 -left-3 z-20 bg-[#2F3C7E] text-white font-bold text-sm w-8 h-8 rounded-full flex items-center justify-center shadow-lg"
                            initial={{ scale: 0, rotate: 180 }}
                            animate={{ scale: 1, rotate: 0 }}
                            transition={{
                              delay: index * 0.1 + 0.7,
                        ...
                        <motion.div
                          className="absolute inset-0 bg-[#2F3C7E]/20 rounded-lg blur-xl"
                          initial={{ opacity: 0 }}
      ...
      {/* Bottom Gradient Bar */}
      <motion.div
        className="absolute bottom-0 left-0 right-0 h-2 bg-[#2F3C7E]"
        initial={{ scaleX: 0 }}
        animate={{ scaleX: 1 }}
