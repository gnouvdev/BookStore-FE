  ...
  "node_modules/react/cjs/react.development.js"(exports, module) {
    ...
    if (true) {
      (function() {
        ...
        function useState9(initialState4) {
          var dispatcher = resolveDispatcher();
...
var require_sweetalert2_all = __commonJS({
  "node_modules/sweetalert2/dist/sweetalert2.all.js"(exports, module) {
    (function(global2, factory) {
      ...
      function _classPrivateFieldInitSpec(e3, t2, a2) {
        _checkPrivateRedeclaration(e3, t2), t2.set(e3, a2);
      }
      ...
      const warnAboutDeprecation = (deprecatedParam, useInstead = null) => {
        warnOnce2(`"${deprecatedParam}" is deprecated and will be removed in the next major release.${useInstead ? ` Use "${useInstead}" instead.` : ""}`);
      };
...
`;
      ...
      const argsToParams = (args) => {
        ...
        if (typeof args[0] === "object" && !isElement(args[0])) {
          ...
          ["title", "html", "icon"].forEach((name4, index) => {
            const arg = args[index];
            if (typeof arg === "string" || isElement(arg)) {
              params[name4] = arg;
            } else if (arg !== void 0) {
              error(`Unexpected type of ${name4}! Expected "string" or "Element", got ${typeof arg}`);
            }
          });
        }
        return params;
    ...
    "undefined" != typeof document && (function(e3, t2) {
      var n3 = e3.createElement("style");
      if (e3.getElementsByTagName("head")[0].appendChild(n3), n3.styleSheet) n3.styleSheet.disabled || (n3.styleSheet.cssText = t2);
      else try {
        n3.innerHTML = t2;
      } catch (e4) {
        n3.innerText = t2;
...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React15 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is3, useSyncExternalStore2 = React15.useSyncExternalStore, useRef8 = React15.useRef, useEffect10 = React15.useEffect, useMemo8 = React15.useMemo, useDebugValue3 = React15.useDebugValue;
...
var AuthContext = (0, import_react18.createContext)(null);
var API_URL = `${import.meta.env.VITE_API_URL}/api`;
var useAuth = () => {
  const context = (0, import_react18.useContext)(AuthContext);
  if (!context) {
...
var OrderPage = () => {
  ...
  const { data: data2, isLoading, isError: isError2, error } = useGetOrdersQuery(currentUser?.email, {
    skip: !currentUser?.email
  });
  const [cancelOrder] = useCancelOrderMutation();
  const orders = [...data2?.data || []].sort((a2, b3) => new Date(b3.createdAt || 0) - new Date(a2.createdAt || 0));
  const statusLabel = (status) => {
    switch (status) {
      case "pending":
        return t2("bookeco.orders.pending", { defaultValue: "Ch\u1EDD x\xE1c nh\u1EADn" });
      case "processing":
        return t2("bookeco.orders.processing", { defaultValue: "\u0110ang x\u1EED l\xFD" });
      case "shipped":
        return t2("bookeco.orders.shipped", { defaultValue: "\u0110ang giao" });
      case "delivered":
        return t2("bookeco.orders.delivered", { defaultValue: "\u0110\xE3 giao" });
      case "cancelled":
        return t2("bookeco.orders.cancelled", { defaultValue: "\u0110\xE3 h\u1EE7y" });
      default:
        return status || t2("common.orders", { defaultValue: "\u0110\u01A1n h\xE0ng" });
    }
  };
  const handleCancel = async (orderId) => {
    const result = await import_sweetalert2.default.fire({
      icon: "warning",
      title: t2("bookeco.orders.cancel_title", { defaultValue: "H\u1EE7y \u0111\u01A1n h\xE0ng n\xE0y?" }),
      text: t2("bookeco.orders.cancel_copy", { defaultValue: "Tr\u1EA1ng th\xE1i \u0111\u01A1n s\u1EBD \u0111\u01B0\u1EE3c c\u1EADp nh\u1EADt ngay sau khi b\u1EA1n x\xE1c nh\u1EADn." }),
      showCancelButton: true,
      confirmButtonText: t2("bookeco.orders.cancel_confirm", { defaultValue: "H\u1EE7y \u0111\u01A1n" }),
      cancelButtonText: t2("cart.cancel", { defaultValue: "Quay l\u1EA1i" })
    });
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("section", { className: "bookeco-desk-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-container", children: t2("bookeco.orders.loading", { defaultValue: "\u0110ang t\u1EA3i \u0111\u01A1n h\xE0ng..." }) }) });
  }
  if (isError2) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("section", { className: "bookeco-desk-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-container", children: error?.data?.message || t2("bookeco.orders.error", { defaultValue: "Kh\xF4ng th\u1EC3 t\u1EA3i \u0111\u01A1n h\xE0ng." }) }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("section", { className: "bookeco-desk-shell", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("header", { className: "bookeco-desk-header", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h1", { children: t2("common.orders", { defaultValue: "L\u1ECBch s\u1EED \u0111\u01A1n h\xE0ng" }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-layout", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("aside", { className: "bookeco-desk-sidebar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("nav", { className: "bookeco-desk-nav", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(Link, { to: "/orders", className: "is-active", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-quote", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.orders.quote", { defaultValue: "M\u1ED7i \u0111\u01A1n h\xE0ng l\xE0 m\u1ED9t l\u1EA7n b\u1EA1n b\u1ED5 sung th\xEAm m\u1ED9t c\xE2u chuy\u1EC7n v\xE0o t\u1EE7 s\xE1ch c\xE1 nh\xE2n." }) }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "BookEco Ledger" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-main", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-section-head", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "bookeco-desk-section-title", children: t2("bookeco.orders.recent", { defaultValue: "C\xE1c \u0111\u01A1n h\xE0ng g\u1EA7n \u0111\xE2y" }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-orders-grid", children: orders.length ? orders.map((order) => {
          const item = order.productIds?.[0];
          const product = item?.productId;
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "bookeco-desk-order-card", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { className: "bookeco-desk-order-cover", src: product?.coverImage || "https://via.placeholder.com/82x118?text=Book", alt: product?.title || "Book" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-order-copy", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-order-meta", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
                statusLabel(order.status),
                " \xB7 ",
                new Date(order.createdAt).toLocaleDateString("vi-VN")
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "bookeco-desk-order-title", children: product?.title || `#${order._id.slice(-6)}` }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: product?.author?.name || `${order.productIds?.length || 0} ${t2("cart.products", { defaultValue: "s\u1EA3n ph\u1EA9m" })}` })
            ] }) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "bookeco-desk-order-actions", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-status", children: statusLabel(order.status) }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("strong", { className: "bookeco-desk-order-price", children: [
                Number(order.totalPrice || 0).toLocaleString("vi-VN"),
                "\u0111"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Link, { to: `/orders/${order._id}`, className: "bookeco-desk-order-link", children: t2("cart.view_details", { defaultValue: "Xem chi ti\u1EBFt" }) }),
              order.status === "pending" || order.status === "processing" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "bookeco-desk-order-cancel", onClick: () => handleCancel(order._id), children: t2("bookeco.orders.cancel_cta", { defaultValue: "H\u1EE7y \u0111\u01A1n h\xE0ng" }) }) : null
            ] })
          ] }, order._id);
        }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "bookeco-desk-quote", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children: t2("bookeco.orders.empty", { defaultValue: "B\u1EA1n ch\u01B0a c\xF3 \u0111\u01A1n h\xE0ng n\xE0o." }) }) }) })
      ] })
    ] })
  ] }) });
};
var OrderPage_default = OrderPage;
export {
  OrderPage_default as default
};
